<template>
    <div class="warp">   
        ...
        <div class="admin-manage">
            <span style="position:absolute;left:80px">项目管理&nbsp; >&nbsp;项目结题查看</span>
            <el-row>
...
export default {
    ...
    mounted: function() {
        ...
        this.initEndPro(this.currentPage,this.pageSize,this.userId);
    },
    methods: {
        initEndPro(pageNum,pageSize,userId){
            let params = {
                pageNum: pageNum,
                pageSize: pageSize,
                userId:this.userId
            }
            axios.post('/api/jsp/FindAllStuEndPro',qs.stringify(params))
            .then(response=>{
                this.tableData = [];
        ...
        handleMore(index,row){
            this.$router.push(`/StudentEndManageInfo/${row.proId}`);
            console.log("更多按钮");
        },
